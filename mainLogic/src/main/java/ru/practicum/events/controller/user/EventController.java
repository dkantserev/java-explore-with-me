...
public class EventController {
    ...
    public EventDto addEvent(@PathVariable(name = "userId") Long userId,
    ...
    public List<EventDto> get(@PathVariable(name = "userId") Long userId,
    ...
    public EventDto get(@PathVariable(name = "userId") Long userId,
